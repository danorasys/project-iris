...
# {"error": {"code", "message", "details"}}. Same contract across all 5
# services.
...
from app.domain.exceptions import DomainError, InternalRouteNotAllowed, UpstreamTimeout, UpstreamUnavailable

logger = logging.getLogger(__name__)

_STATUS_BY_ERROR: dict[type[DomainError], int] = {
    InternalRouteNotAllowed: status.HTTP_404_NOT_FOUND,
    UpstreamUnavailable: status.HTTP_502_BAD_GATEWAY,
