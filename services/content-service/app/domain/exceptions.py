...
used across all 5 services (Phase 5 renamed these from the original
`codigo`/`mensaje`/`detalles`). The `code` and `message` VALUES are kept in
Spanish: they're user-facing content, not Python identifiers, and renaming
them isn't part of that phase's scope."""
